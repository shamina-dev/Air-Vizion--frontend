...
const firebaseConfig = {
    ...
    databaseURL: "https://form-d37db-default-rtdb.asia-southeast1.firebasedatabase.app",
...
export default function Dashboard() {
    ...
    useEffect(() => {
        ...
        onValue(dataRef, (snapshot) => {
            ...
            dataArray.slice(-20).forEach((entry) => {
                timestamps.push(new Date(entry.timestamp).toLocaleString("en-GB"));
                O3.push(entry.O3 || 0);
    ...
    useEffect(() => {
        if (chartData.timestamps.length > 0) {
            const chartConfigs = [
                { id: "chartO3", label: "O3 (µg/m³)", data: chartData.O3, color: "#FF6384" },
                { id: "chartNO2", label: "NO2 (µg/m³)", data: chartData.NO2, color: "#36A2EB" },
                { id: "chartSO2", label: "SO2 (µg/m³)", data: chartData.SO2, color: "#FFCE56" },
                { id: "chartCO", label: "CO (µg/m³)", data: chartData.CO, color: "#4BC0C0" },
        ...
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold">Dashboard</h2>}>
            ...
            <div className="dashboard-container">
                ...
                <div className="chart-container">
                    <div className="chart-box"><canvas id="chartO3"></canvas></div>
                    <div className="chart-box"><canvas id="chartNO2"></canvas></div>
                    <div className="chart-box"><canvas id="chartSO2"></canvas></div>
                    <div className="chart-box"><canvas id="chartCO"></canvas></div>
